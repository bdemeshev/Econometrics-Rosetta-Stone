...
На графиках видим отличные от предыдущих 2-х сетов графиков. Почему так происходит -- хороший исследовательский вопрос!https://stats.stackexchange.com/questions/169891/same-data-different-pacf-r-vs-stata рекомендует приписать ", yw" после "ac/pac", но это не работает на моём примере.
